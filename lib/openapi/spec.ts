...
export function getOpenApiSpec(): OpenApiDocument {
    ...
    // Must run first — patches this module's z instance before any .openapi() calls
    ...
    const s = buildSchemas(z, registry);
    const p = buildParameters(z);

    const errorContent = { "application/json": { schema: s.ErrorResponseSchema } };
    ...
    registry.registerPath({
        ...
        responses: {
            201: {
                ...
                content: { "application/json": { schema: z.object({ data: s.UserSchema }) } },
            },
    ...
    registry.registerPath({
        ...
        responses: {
            200: {
                ...
                content: { "application/json": { schema: s.UserListResponseSchema } },
            },
            ...errorResponses,
        },
    });
    ...
    registry.registerPath({
        ...
        request: {
            body: {
                required: true,
                content: { "application/json": { schema: s.AdminUserCreateRequestSchema } },
            },
        },
        responses: {
            201: {
    ...
    registry.registerPath({
        ...
        request: {
            ...
            body: {
                required: true,
                content: { "application/json": { schema: s.AdminUserUpdateRequestSchema } },
            },
        },
        responses: {
            200: {
    ...
    registry.registerPath({
        ...
        responses: {
            200: {
                ...
                content: { "application/json": { schema: s.RoomListResponseSchema } },
            },
            ...errorResponses,
        },
    });
    ...
    registry.registerPath({
        ...
        request: {
            body: {
                required: true,
                content: { "application/json": { schema: s.RoomCreateRequestSchema } },
            },
        },
        responses: {
            201: {
                description: "Room created",
                content: { "application/json": { schema: z.object({ data: s.RoomSchema }) } },
            },
            ...errorResponses,
        },
    });
    ...
    registry.registerPath({
        ...
        request: {
            ...
            body: {
                required: true,
                content: { "application/json": { schema: s.RoomUpdateRequestSchema } },
            },
        },
        responses: {
            200: {
    ...
    registry.registerPath({
        ...
        responses: {
            200: {
                ...
                content: { "application/json": { schema: s.AccessCardListResponseSchema } },
            },
            ...errorResponses,
        },
    });
    ...
    registry.registerPath({
        ...
        request: {
            body: {
                required: true,
                content: { "application/json": { schema: s.AccessCardCreateRequestSchema } },
            },
        },
        responses: {
            201: {
                ...
                content: {
                    "application/json": { schema: z.object({ data: s.AccessCardSchema }) },
                },
            },
    ...
    registry.registerPath({
        ...
        request: {
            ...
            body: {
                required: true,
                content: { "application/json": { schema: s.AccessCardUpdateRequestSchema } },
            },
        },
        responses: {
            200: {
    ...
    registry.registerPath({
        ...
        responses: {
            200: {
                ...
                content: { "application/json": { schema: s.AccessPermissionListResponseSchema } },
            },
            ...errorResponses,
        },
    });
    ...
    registry.registerPath({
        ...
        request: {
            body: {
                required: true,
                content: {
                    "application/json": { schema: s.AccessPermissionCreateRequestSchema },
                },
            },
        },
        responses: {
            201: {
                ...
                content: {
                    "application/json": { schema: z.object({ data: s.AccessPermissionSchema }) },
                },
            },
            ...errorResponses,
        },
    ...
    registry.registerPath({
        ...
        request: {
            ...
            body: {
                required: true,
                content: {
                    "application/json": { schema: s.AccessPermissionUpdateRequestSchema },
                },
            },
        },
        responses: {
    ...
    registry.registerPath({
        ...
        security: bearerAuth,
        request: {
            query: p.paginationQuery.extend(
                z.object({
                    userId: z.coerce
                        .number()
                        .int()
                    ...
                    from: z.iso
                        .datetime()
                        .optional()
                        .openapi({ description: "requestedAt ≥ from (ISO 8601)" }),
                    to: z.iso
                        .datetime()
                        .optional()
                        .openapi({ description: "requestedAt ≤ to (ISO 8601)" }),
                }).shape,
            ),
        },
        responses: {
            200: {
                ...
                content: { "application/json": { schema: s.AccessRequestListResponseSchema } },
            },
            ...errorResponses,
        },
    });
    ...
    registry.registerPath({
        ...
        security: bearerAuth,
        request: { params: p.bigIntPathParams },
        responses: {
            200: {
                description: "Access request",
                content: {
                    "application/json": { schema: z.object({ data: s.AccessRequestSchema }) },
                },
            },
            404: { description: "Not found" },
            ...
            query: p.paginationQuery.extend(
                z.object({
                    ...
                    from: z.iso
                        .datetime()
                        .optional()
                        .openapi({ description: "completedAt ≥ from (ISO 8601)" }),
                    to: z.iso
                        .datetime()
                        .optional()
                        .openapi({ description: "completedAt ≤ to (ISO 8601)" }),
                }).shape,
            ),
        },
        responses: {
            200: {
                ...
                content: { "application/json": { schema: s.AccessResultListResponseSchema } },
            },
            ...errorResponses,
        },
    });
    ...
    registry.registerPath({
        ...
        responses: {
            200: {
                ...
                content: {
                    "application/json": { schema: z.object({ data: s.AccessResultSchema }) },
                },
            },
            404: { description: "Not found" },
            ...bigIntErrorResponses,
